    ...
    <section className="py-20 bg-base-100 px-4 md:px-8">
      <div className="w-11/12 mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h3 className="text-4xl md:text-5xl font-extrabold text-accent mb-4">
        ...
        <div className="w-full space-x-6 bg-transparent grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-y-8 gap-x-4 rounded-box mb-20 justify-center items-center">
          {testimonials.map((item) => (
            <div
              key={item.id}
              className="card w-full bg-base-200 shadow relative pt-10 px-6 pb-8"
            >
        ...
        <div className="pt-10 border-t border-base-300">
          <p className="text-center text-accent font-bold uppercase text-xs mb-10">
